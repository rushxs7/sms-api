...
<div class="container">
  ...
  <div class="row mb-4">
    <div class="col-3">
      <h4 class="ps-2 pt-3">Edit Send Job</h4>
      <hr>
    </div>
    <div class="col-9">
      <div class="card">
        <div class="card-body">
          <form action="{{ route('smsservice.update') }}" method="post" autocomplete="off">
            @csrf
            @method("PUT")
            <div class="mb-3">
              <h4>Job Type</h4>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="type" id="type-instant" value="instant" {{ $sendJob->type == 'instant' ? 'checked' : '' }}>
                <label class="form-check-label" for="type-instant">Instant</label>
              </div>
              <div class="form-check">
                <input class="form-check-input" type="radio" name="type" id="type-scheduled" value="scheduled" {{ $sendJob->type == 'scheduled' ? 'checked' : '' }}>
